...
$settings["files"]["dir"] 		= "../../uploads/files"; //without the trailing slash!
$settings["files"]["url_dir"] 	= _navigation::GetBaseURL()."uploads/files"; //without the leading or trailing slash!
$settings["files"]["ext"] 		= array("pdf","doc","html","htm","rtf","zip","tar","gz");
$settings["files"]["type"] 		= 1; //1 => file browser, 2 => image browser

$settings["img"]["dir"] 		= "../../uploads/pics"; //without the trailing slash!
$settings["img"]["url_dir"] 	= _navigation::GetBaseURL()."uploads/pics"; //without the leading or trailing slash!
$settings["img"]["ext"] 		= array("jpg", "bmp", "png", "gif");
$settings["img"]["type"] 		= 2; //1 => file browser, 2 => image browser

$settings["flash"]["dir"] 		= "../../uploads/files"; //without the trailing slash!
$settings["flash"]["url_dir"] 	= _navigation::GetBaseURL()."uploads/files"; //without the leading or trailing slash!
