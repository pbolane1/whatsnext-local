...
<body class='admin'>
	<?php $__headline__=$admin->IsLoggedIn()?'Manage Animations':'Admin Login';?>
...
<?php
	...
	else
	{
		...
		$list->SetHTML('BEFORE_NEW',"<tr><th colspan='5' class='area'>Manage Animations</th></tr>");
		$list->SetHTML('BEFORE_EXISTING',"<tr>".$list->Header('ITEM').$list->Header('ACTION','',2)."</tr>");
		$list->SetHTML('BEFORE_EDIT_NEW',"<tr><th colspan='15'>New Animation</h3></th></tr>");
		$list->SetHTML('BEFORE_EDIT_EXISTING',"<tr><th colspan='5'>Edit Animation</h3></th></tr>");
		$list->SetHTML('EMPTY_SET',"<tr><td colspan='5' class='emptyset'>There are animations to display</td></tr>");	
		$list->num_new=1;
	  	$list->Retrieve();
		$list->ProcessAction();
		//$list->CheckSortOrder();
