...
//	var elm = inst.getFocusElement();
	...
	var html = "<img class='insertlist mceNonEditable' list_id='"+getSelectValue(formObj, 'list_id')+"' title='"+document.getElementById('list_id').options[document.getElementById('list_id').selectedIndex].innerHTML+"'/>";
//	html+="<p></p>";
