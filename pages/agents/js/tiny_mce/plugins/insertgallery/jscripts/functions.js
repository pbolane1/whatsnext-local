...
//	var elm = inst.getFocusElement();
	...
	var html = "<img class='insertgallery mceNonEditable' gallery_id='"+getSelectValue(formObj, 'gallery_id')+"' title='"+document.getElementById('gallery_id').options[document.getElementById('gallery_id').selectedIndex].innerHTML+"'/>";
//	html+="<p></p>";
